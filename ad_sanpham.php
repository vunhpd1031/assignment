        ...
        <div id="content">
       	  <div id="menu">
  			...
  			<form action="admin_Xuly_SP.php" method="POST" enctype="multipart/form-data" >
										...
										<p class="chung"><span>Mã Sản Phẩm </span><input type="text" name="MaSP" maxlength="5" placeholder="Ví dụ: HD001, HD002" ></input></p>
										<p class="chung"><span>Tên Sản Phẩm </span><input type="text" name="TenSP"></input></p>
										<p class="chung"><span>Đơn Giá </span><input type="text" name="DonGia"></input></p>
										<span>Hình ảnh:</span>
										<input class="chung" type="file" name="File" value="Chọn file">
										<p class="chung"><span>Mô Tả</span><input type="text" name="MoTa"></input></p>
